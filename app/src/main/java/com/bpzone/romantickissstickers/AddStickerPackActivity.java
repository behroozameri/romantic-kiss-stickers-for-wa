...
public abstract class AddStickerPackActivity extends BaseActivity {
    ...
    protected void addStickerPackToWhatsApp(String identifier, String stickerPackName) {
        try {
            ...
            WriteLog.GetInstance().addToLog(TAG, "addStickerPackToWhatsApp", e.getMessage(), e);
            Toast.makeText(this, R.string.add_pack_fail_prompt_update_whatsapp, Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void launchIntentToAddPackToSpecificPackage(String identifier, String stickerPackName, String whatsappPackageName) {
        try {
            ...
            WriteLog.GetInstance().addToLog(TAG, "launchIntentToAddPackToSpecificPackage", e.getMessage(), e);
        }
    }
    ...
    private void launchIntentToAddPackToChooser(String identifier, String stickerPackName) {
        try {
            ...
            WriteLog.GetInstance().addToLog(TAG, "launchIntentToAddPackToChooser", e.getMessage(), e);
        }
    }
    ...
    private Intent createIntentToAddStickerPack(String identifier, String stickerPackName) {
        try {
            ...
            WriteLog.GetInstance().addToLog(TAG, "createIntentToAddStickerPack", e.getMessage(), e);
            return null;
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            WriteLog.GetInstance().addToLog(TAG, "onActivityResult", e.getMessage(), e);
        }
    }
    ...
    public static final class StickerPackNotAddedMessageFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            try {
                ...
                WriteLog.GetInstance().addToLog(TAG, "onCreateDialog", e.getMessage(), e);
                return null;
            }
        }
        ...
        private void launchWhatsAppPlayStorePage() {
            try {
                ...
                WriteLog.GetInstance().addToLog(TAG, "launchWhatsAppPlayStorePage", e.getMessage(), e);
            }
        }
        ...
        private void launchPlayStoreWithUri(String uriString) {
            try {
                ...
                WriteLog.GetInstance().addToLog(TAG, "launchPlayStoreWithUri", e.getMessage(), e);
            }
        }
    }
}
